        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Perfil = table.Column<string>(type: "TEXT", maxLength: 40, nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FuncionariosConvites", x => x.Id);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_FuncionariosConvites_CodigoHash",
                table: "FuncionariosConvites",
                column: "CodigoHash",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_FuncionariosConvites_Email",
                table: "FuncionariosConvites",
                column: "Email");
        }
