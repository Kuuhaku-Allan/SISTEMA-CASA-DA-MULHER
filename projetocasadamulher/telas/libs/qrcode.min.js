(function (global) {
    ...
    function QRCode(element, options) {
        ...
        if (!target) {
            throw new Error("Elemento do QR Code nao encontrado.");
        }
